...
params = list()
params$working_dir = "/mnt/genouest/groups/bipaa/work/Acyrthosyphon_pisum/EGI/grichard/BP/STIRRER/RNA-seq/"
...
cmd="wget ftp://parrot.genomics.cn/gigadb/pub/10.5524/100001_101000/100814/Assembly/BnapusDarmor-bzh_chromosomes.fasta.gz -O ../genome/darmor10.fa.gz ;
     createIndices --genome ../genome/darmor10.fa.gz --gtf ../genome/darmor10.gtf -o ../genome/darmor10_indices darmor10_test"
...
cmd="mRNA-seq --input input/ -c  -o ../genome/darmor10_indices darmor10"
